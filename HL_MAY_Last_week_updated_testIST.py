...
def run_london():
    ...
    if shortsum > 1 and longsum > 1:
        ...
        currtime = datetime.now().strftime('%H:%M:%S')
        if currtime < "17:29:25":
            sleeptime = (
                    datetime.strptime("17:29:26", '%H:%M:%S') - datetime.strptime(currtime, '%H:%M:%S')).total_seconds()
            print("LONDON ENTRIES WILL START AT 17:29:26, SECS LEFT: ", sleeptime)
            time.sleep(sleeptime)
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'EUR.NOK', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat, EURNOK_params, ids6, 1200, 1300, london_df,london_exit_df)).start()
        ##############################################
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'EUR.SEK', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat, EURSEK_params, ids7, 1400, 1500, london_df,london_exit_df)).start()
        ##################################################################
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'GBP.NOK', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat, GBPNOK_params, ids8, 1600, 1700, london_df,london_exit_df)).start()
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'NOK.SEK', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat, NOKSEK_params, ids9, 1800, 1900, london_df,london_exit_df)).start()
