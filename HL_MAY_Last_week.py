                ...
                if condition_buy == "NOT FULFILLED":
                    ...
                    if flag_buy==True:
                        if rt_price[0] <= tp_buy2:
                            ...
                            print("CONDITION MET FOR", params[0], signal, "at", fetchtime, "MID PRICE:",rt_price[2], "TRYING TO PLACE AT ASK:",rt_price[0])
                            id = int(ids[1][0])
                ...
                if condition_sell == "NOT FULFILLED":
                    ...
                    if flag_sell==True:
                        if rt_price[1]>= tp_sell2:
                            ...
                            print("CONDITION MET FOR", params[0], signal, "at", fetchtime, "MID PRICE:", rt_price[2], "TRYING TO PLACE AT BID:",rt_price[1])
                            id = int(ids[0][0])
                            price = float(round(rt_price[1], round1))
                            qty = abs(pos)
