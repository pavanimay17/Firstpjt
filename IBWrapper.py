...
class contract():
    def create_contract(self, symbol, secType, exchange, currency,
                        ...
                        multiplier=None,lsym=None, tradingClass=None):
        contract = Contract()
        ...
        contract.m_localSymbol=lsym
        return contract


    def create_order(self, account, orderType, totalQuantity, action, lmt, transmit,tif,gtd,initsize,subsize,princrement,pradjval,pradjinterval):
        order = Order()
